...
protected:
	...
	// we use a dib to draw the minimap; the DIB itself lives in
	// CMapMinimap (see MapMinimap.h)
	CMapMinimap m_minimap;
	...
	// minimap pixel math + per-cell colors moved to CMapMinimap /
	// MapData.cpp (the header used to carry ~200 lines of inline
	// implementations here)
	void GetMiniMapPos(int i, int e, int& x, int& y);
